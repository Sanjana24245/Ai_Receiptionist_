...
const CallsManagement = ({ calls = dummyCalls }) => {
  return (
      ...
      <div className="flex-1 p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Monitor calls and chats handled by AI and human agents
          </p>
        </div>
                    ...
                    <tr key={call.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900">
                        {call.appointmentDetails ? (
                          <div>
                            <div>
                              {call.appointmentDetails.date} at{" "}
                              {call.appointmentDetails.time}
                            </div>
                            <div className="text-xs text-gray-500">
                              {call.appointmentDetails.doctor}
                            </div>
                          </div>
                        ) : (
